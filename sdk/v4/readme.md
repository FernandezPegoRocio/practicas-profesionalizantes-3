...
— backend/ — 
main.mjs   : se encarga del servidor, router, dispatcher, configuración, conexión a la BD, autenticador, autorizador, sesión, datos de 
prueba y cabeceras CORS
...
La función RPCApiFetch(path, input) centraliza todas las peticiones,
   analiza el código de estado de la respuesta y lanza la excepción
   correspondiente. 
...
1. Iniciar el backend:
      ...
      node main.mjs
2. Colocar el contenido de sdk/v4/frontend en la carpeta raíz de Apache.
